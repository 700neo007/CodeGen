...
<mapper namespace="${myBatisMapperPackage}.${modelName}Mapper">
	...
	<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~ You can change the part! Enjoy! ~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
	<sql id="Base_Where_Cond">
		<trim prefix="where" prefixOverrides="and |or">
			<if test="${primaryKeyPropertyName} != null">
				and ${generatorUtil.underline2CamelNaming(modelName)}.${primaryKeyColumnName} = #${r"{"}${primaryKeyPropertyName}${r"}"} 
			</if>
		</trim>
	</sql>
